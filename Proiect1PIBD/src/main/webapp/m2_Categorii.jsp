...
<body>
	...
	<%
	jb.connect();
	int aux = java.lang.Integer.parseInt(request.getParameter("idcategorii"));
	String Nume = request.getParameter("nume");
	String Popularitate = request.getParameter("popularitate");
	String Tara = request.getParameter("tara");
	String[] valori = { Nume, Popularitate, Tara };
	String[] campuri = { "nume", "popularitate", "tara" };
	jb.modificaTabela("categorii", "idcategorii", aux, campuri, valori);
	jb.disconnect();
	%>
