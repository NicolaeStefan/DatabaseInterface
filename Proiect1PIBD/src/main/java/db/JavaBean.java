...
ResultSet.CONCUR_READ_ONLY*/);
	...
	public ResultSet vedeMetadata() throws SQLException, Exception {
		ResultSet rs = null;
		try {
			String queryString = ("select a.nume numefilm, a.durata duratafilm, a.rating ratingfilm, "
					+ "b.nume numecategorii, b.popularitate popularitatecategorii, b.tara taracategorii, c.idmetadata, "
					+ "c.idcategorii idcategorii_1, c.idfilme idfilm_1, c.an_de_lansare, "
